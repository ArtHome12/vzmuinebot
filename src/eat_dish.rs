            ...
            cmd::EaterDish::UnknownCommand => {
               ...
               match cmd::Common::from(command) {
                  ...
                  cmd::Common::SendMessage(caterer_id) => {
                     ...
                     next(cmd::Dialogue::MessageToCaterer(rest_id, caterer_id, Box::new(cmd::Dialogue::EatRestGroupDishSelectionMode(compact_mode, cat_id, rest_id, group_id)), Box::new(cmd::EaterDish::markup())))
                  }
